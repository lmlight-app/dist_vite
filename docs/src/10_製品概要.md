...
- 主要オペレータ:
  - **クラウドストレージ**: S3, GCS, Azure Blob, Box, Dropbox, OneDrive, SharePoint, Google Drive, Google Sheets
  - **ファイル転送**: SFTP, FTP / FTPS, SMB / CIFS, WebDAV / HTTP files, rsync
  - **API連携**: kintone, Salesforce, freee, MoneyForward, Sansan
  - **データ基盤**: Snowflake, BigQuery, Elasticsearch, PostgreSQL, REST/HTTP, RSS
